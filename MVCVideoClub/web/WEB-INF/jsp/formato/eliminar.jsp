                                        ...
                                        <form method="POST" class="form-horizontal form-label-left input_mask">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4 col-sm-4 col-xs-9">
                                                    <label name="socio.cedula" class="form-control has-feedback-left">${formato[0].FOR_ID}</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4 col-sm-4 col-xs-9">
                                                    <label name="socio.cedula" class="form-control has-feedback-left">${formato[0].FOR_NOMBRE}</label>
